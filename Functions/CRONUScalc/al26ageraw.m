%
%  age=al26ageraw(sampledata,pp,sf,scaling_model)
%
...
%
function output=al26ageraw(sampledata,pp,sf,scaling_model)
%
...
% production rate.  This is depthtotop + maxage * erosion rate (g/cm2/kyr)
...
srate=(thick'*PsAl)/totalthickness;
murate=(thick'*PmuAl)/totalthickness;
Qs=srate/PsAl(1);
Qmu=murate/PmuAl(1);
%
% Setup the output vector.
%
output=[age; 0; sf.currentsf.Sel26; cp.SFmufast; cp.SFmuslow; srate; murate; ...
	Qs; Qmu; sp.inheritance26; sp.concentration26; 0];
