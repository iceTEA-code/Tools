%
% [output,times,plotprodbe,derivs]=be10age_mod(sampledata,sampleuncertainties,scaling_model)
%
...
%
% This is a modified version of CronusCalc's be10age.m. Uncertainties are
% calculated based only on elevation (pressure) and 10Be measurement 
% uncertainty.
%
...
%
%
function [output,times,plotprodbe,derivs]=be10age_mod(sampledata,sampleuncertainties,scaling_model)
  expectedOutputs = 12;
  %
  ...
  % MODIFICATION: Only work through pressure and measurement uncertainties.
  %
  uncert_mask = [4,9];
