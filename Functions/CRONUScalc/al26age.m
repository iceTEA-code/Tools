%
% [output,times,plotprodal,derivs]=al26age(sampledata,sampleuncertainties,s
% caling_model)
%
...
%
function [output,times,plotprodal,derivs]=al26age(sampledata,sampleuncertainties,scaling_model)
  expectedOutputs = 12;
  %
