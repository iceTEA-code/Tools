function [pflux] = ProtonsX(h,Rc,s,consts)

%reduced version that does not do any cross-sections
...
%     P36p(a) = (trapz(E,phiPtot.*consts.KpxCl36)+trapz(E,phiPtot.*consts.CapxCl36)+trapz(E,phiPtot.*consts.FepxCl36)+trapz(E,phiPtot.*consts.TipxCl36)).*consts.Natoms36.*1e-27.*3.1536e7;
